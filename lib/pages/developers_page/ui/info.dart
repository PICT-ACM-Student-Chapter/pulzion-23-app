...
class DeveloperData {
  ...
  String imageUrl = "";
  DeveloperData(
      this.name, this.emailId, this.gitHubId, this.linkedInId, this.imageUrl);
}
...
List<DeveloperData> data = [
  ...
  DeveloperData(
      ...
      "https://firebasestorage.googleapis.com/v0/b/fcmtestserver-86214.appspot.com/o/5.jpg?alt=media"),
  DeveloperData(
      "Tarun Santani",
  ...
  DeveloperData(
      ...
      "https://firebasestorage.googleapis.com/v0/b/fcmtestserver-86214.appspot.com/o/8.jpg?alt=media"),
  DeveloperData(
      "Ankita Darade",
