...
//   ViewAllEvents({super.key});

//   @override
//   State<ViewAllEvents> createState() => _ViewAllEventsState();
// }

// class _ViewAllEventsState extends State<ViewAllEvents>  with SingleTickerProviderStateMixin{
...
//             children: [
//               EventGridView(
//                   state.events.events!.where((element) => element.type == "Technical").toList()),
